...
def get_args_parser():
    ...
    from graph_soft import PoolingStrategy
    ...
    group3.add_argument('-port', '-port_in', '-port_data', type=int, default=5575,
                        help='server port for receiving data from client')
    group3.add_argument('-port_out', '-port_result', type=int, default=5576,
                        help='server port for sending result to client')
    group3.add_argument('-http_port', type=int, default=8080,
    ...
    group3.add_argument('-show_tokens_to_client',type=bool,default=True,
                        help='whether show tokens to client')
